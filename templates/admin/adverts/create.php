...
<?php $this->setTitle($title ?? "Admin | Create Advertisement"); ?>
...
<div class="col-md-12">
    ...
    <div class="row g-5">
        ...
        <div class="col-md-7 col-lg-8">
            ...
            <div class="row g-3">
                <?= BootstrapForm::selectField("Advertisement Priority", "priority", old_select("priority", $advert["priority"] ?? ''), $priorityOpts, ['class' => 'form-control'], ['class' => 'col-sm-6 mb-3'], $errors) ?>

                <?= BootstrapForm::selectField("Advertisement Status", "status", old_select("status", $advert["status"] ?? ''), $statusOpts, ['class' => 'form-control'], ['class' => 'col-sm-6 mb-3'], $errors) ?>
            </div>

            <?= BootstrapForm::submitButton("Create Advert", "btn btn-dark btn-sm mt-2 mb-2 fs-6 w-100") ?>
        </div>
    </div>
