            ...
            <div class="card mb-3" style="max-width: 540px;">
                <div class="row g-0">
                    <div class="col-md-4 p-3">
                        <img src="<?= get_image($resource->thumbnail) ?>" class="img-fluid rounded-start" alt="...">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <th>Status: </th>
                                    <td>
                                        <?= statusVerification($resource->status) ?>
                                    </td>
                                </tr>
                                <tr>
                                    <th>Category: </th>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="<?= URL_ROOT ?>admin/manage-resources" class="btn btn-danger"
