...
<?php $this->setTitle($title ?? "Admin | Edit Article"); ?>
...
<div class="row g-5">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center p-2">
            <div class="card shadow my-2 p-2 w-100">
                ...
                <?php if ($upload_type === "file") : ?>
                    <a href="<?= URL_ROOT ?>admin/articles/edit?ut=link" class="btn btn-outline-secondary my-2">Link Upload</a>
                <?php else : ?>
                    <a href="<?= URL_ROOT ?>admin/articles/edit?ut=file" class="btn btn-outline-primary my-2">File Upload</a>
                <?php endif; ?>
            </div>
            <div class="card shadow my-2 p-2">
                <h2 class="text-center">Thumbnail Image</h2>
                <img src="<?= get_image($article->thumbnail); ?>" alt="" class="mx-auto d-block thumbnail-preview" style="height:250px;width:300px;object-fit:cover;border-radius: 10px;cursor: pointer;">
            ...
            <div class="card shadow my-2 p-2">
                ...
                <img src="<?= get_image($article->image); ?>" alt="" class="mx-auto d-block image-preview" style="height:250px;width:300px;object-fit:cover;border-radius: 10px;cursor: pointer;">
    ...
    <div class="col-md-7 col-lg-8">
        <h4 class="mb-3">Update Article</h4>
        <div class="row g-3">
            <?= BootstrapForm::inputField("Article Title", "title", old_value("title", $article->title ?? ''), ['class' => 'form-control'], ['class' => 'col-sm-12'], $errors) ?>

            <?= BootstrapForm::selectField("Article Category", "category_id", $article->category_id ?? '', $categoryOpts, ['class' => 'form-control'], ['class' => 'col-6 mb-3'], $errors) ?>

            <?= BootstrapForm::selectField("Article Region", "region_id", $article->region_id ?? '', $regionOpts, ['class' => 'form-control'], ['class' => 'col-6 mb-3'], $errors) ?>
