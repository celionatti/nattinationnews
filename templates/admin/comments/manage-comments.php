...
<div class="row g-5">
    <div class="col-md-12">
        ...
        <div class="controls d-flex justify-content-between align-items-center">
            <a href="<?= URL_ROOT . "admin/failed-comments" ?>" class="btn btn-outline-warning btn-sm px-3"><i class="bi bi-chat-text"></i> Failed Comments</a>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        function showAllComments() {
            $.ajax({
                url: "<?= URL_ROOT ?>admin/view-comments",
                type: "POST",
                data: {
