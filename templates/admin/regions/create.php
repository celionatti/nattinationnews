...
<?php $this->setTitle($title ?? "Admin | Create Region"); ?>
...
<div class="row g-5">
    ...
    <div class="col-12">
        <h4 class="mb-3">Create Region</h4>
        ...
        <?= BootstrapForm::selectField("Status", "status", old_select("status", $region["status"] ?? ''), $statusOpts, ['class' => 'form-control'], ['class' => 'col-12 mb-3'], $errors) ?>

        <?= BootstrapForm::submitButton("Create Region", "btn btn-dark btn-sm mx-1 mb-2 fs-6 w-100") ?>
