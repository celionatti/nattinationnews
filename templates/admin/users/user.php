...
<div class="row g-5">
    ...
    <div class="col-md-7 col-lg-8">
        ...
        <div class="row g-3">
            ...
            <?= BootstrapForm::selectField("Gender", "gender", old_select("gender", $user["gender"] ?? ''), $genderOpts, ['class' => 'form-control'], ['class' => 'col-sm-6'], $errors) ?>
            <?= BootstrapForm::selectField("Role", "role", old_select("role", $user["role"] ?? ''), $roleOpts, ['class' => 'form-control'], ['class' => 'col-sm-12'], $errors) ?>
        </div>
