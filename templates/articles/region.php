                                ...
                                <?php foreach ($regions as $region) : ?>
                                    <article class="col-md-6 animate-box section_margin">
                                        ...
                                        <div class="post_meta">
                                            ...
                                            <span class="meta_author_name text-capitalize"><a class='author' href="<?= URL_ROOT . "author/{$region->user_id}" ?>"><?= getCombinedData(getArticleUser($region->user_id), "surname", "name") ?></a></span>
