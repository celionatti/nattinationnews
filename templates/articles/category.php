                                    ...
                                    <article class="col-md-6 animate-box section_margin">
                                        <div class="wrap">
                                            <figure class="alith_news_img">
                                                ...
                                                <a href="<?= URL_ROOT . "article/{$category->article_id}/{$token}" ?>"><img src="<?= get_image($category->thumbnail) ?>" alt="<?= $category->thumbnail_caption ?>" class="img-fluid w-100 rounded-2" style="height:357px;object-fit:cover;" /></a>
                                            </figure>
                                        </div>
